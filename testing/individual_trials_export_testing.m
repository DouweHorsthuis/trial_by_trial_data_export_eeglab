...
load_path  = '\\data.einsteinmed.org\users\Ana and Douwe\22Q\IAPS\data\0.1Hz\';
save_path= '\\data.einsteinmed.org\users\Ana and Douwe\22Q\IAPS\data\';
typefile= '.xlsx';% final file can be saved as mat, txt, dat, csv, xls, xlsm, xlsx or xlsb
time_window = [300 500];%specify the begin and end points of the time window of interest in ms either a specific point for N1/MMN/P2
name_timewindow= 'ErrorRelatedPositivity';
chan = 'Fp1'; %channel of interest 
name_file = '_epoched'; %the name after the IDnumber (excluding .set)
events_in_epoch_cond1 = {'85' '86'}; % what triggers need to be exported.
events_in_epoch_cond2 = {'75' '76'}; %
